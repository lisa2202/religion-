...
const AnyOtherEmail: NextPage<AnyOtherEmailProps> = () => {
  ...
  const onSubmit = async () => {
    ...
    push(
      process.env.NEXT_PUBLIC_DOCS_PAGE === `ON`
        ? `/customerservice/supportingdocuments`
        : `/customerservice/confirmation`
    );
  };
...
AnyOtherEmail.getInitialProps = ({ res, req, ...props }) => {
